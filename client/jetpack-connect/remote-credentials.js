...
export class OrgCredentialsForm extends Component {
	...
	handleSubmit = event => {
		const { installResponse, siteToConnect } = this.props;
...
export default connect( state => {
	...
	const installResponse = getJetpackRemoteInstallError( state, siteToConnect );
	return {
		installResponse,
		siteToConnect,
	};
},
{ jetpackRemoteInstall, getJetpackRemoteInstallError } )( localize( OrgCredentialsForm ) );
